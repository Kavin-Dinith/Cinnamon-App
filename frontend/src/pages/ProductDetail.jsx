            ...
            <div className="pt-4 border-t border-slate-200">
              ...
              <ul className="space-y-2 font-googleSans text-sm text-slate-700">
                <li className="flex items-center gap-2">
                  <CreditCard className="w-4 h-4 text-amber-500" /> Cash on
                  Delivery – No card details required
                </li>
                <li className="flex items-center gap-2">
                  <Truck className="w-4 h-4 text-amber-500" /> Fast and safe
                  delivery to your doorstep
                </li>
                <li className="flex items-center gap-2">
                  <Package className="w-4 h-4 text-amber-500" /> Carefully
                  packaged for freshness & quality
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-amber-500" /> Easy order
                  process – Click “Buy Now”
                </li>
              </ul>
            </div>
          </div>
